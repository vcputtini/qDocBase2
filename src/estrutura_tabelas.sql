-- ====================================================================
-- ATENCAO: REMOVER DO BANCO DE DADOS DE PRODUCAO ATIVO
--          OS CAMPOS ET_OBMOD E ET_OBDEPE DA TABELA DOCENTITY.
--          MODIFICAR O TIPO DE ET_OBCOD DE TINYINT PARA SMALLINT.
--
-- ALTER TABLE DOCENTITY MODIFY ET_OBCOD SMALLINT;
-- ALTER TABLE DOCENTITY MODIFY ET_UF CHAR(2) DEFAULT NULL;
-- ALTER TABLE DOCENTITY MODIFY ET_CEP CHAR(10) DEFAULT NULL;
-- ALTER TABLE DOCENTITY MODIFY ET_OBCOD SMALLINT;
-- ALTER TABLE DOCENTITY DROP ET_OBMOD;
-- ALTER TABLE DOCENTITY DROP ET_OBDEPE;
--
-- UPDATE DOCENTITY SET ET_UF=NULL WHERE ET_CITY='';
--
-- UPDATE DOCENTITY SET ET_CEP=NULL  WHERE ET_CEP='.-';
-- UPDATE DOCENTITY SET ET_CEP=NULL  WHERE ET_CEP='';
--
-- UPDATE DOCENTITY SET ET_CPF=NULL WHERE ET_CPF='..-';
-- UPDATE DOCENTITY SET ET_CNPJ=NULL WHERE ET_CNPJ='../-';
-- UPDATE DOCENTITY SET ET_IE=NULL WHERE ET_IE='...';
--
-- UPDATE DOCENTITY SET ET_RG=NULL WHERE ET_RG='..-/-';
-- UPDATE DOCENTITY SET ET_RG=NULL WHERE ET_RG='..-//--';
-- UPDATE DOCENTITY SET ET_RG=NULL WHERE ET_RG='..-//---';
-- UPDATE DOCENTITY SET ET_RG=NULL WHERE ET_RG='..-//----';
-- UPDATE DOCENTITY SET ET_RG=NULL WHERE ET_RG='';
-- ====================================================================
--
-- NOVO NOME DO BANCO DE DADOS: DOCBASE
--
--
...
--
-- 2013-06-18 - Nova tabela
-- alterada em: 2013-08-02 - inclusao do campo ACT_DOCID
CREATE TABLE DOCSYSACTIVITY (
    ...
    ACT_DOCID       BIGINT  UNSIGNED    DEFAULT NULL,
    PRIMARY KEY(ACT_ID),
    KEY(ACT_TIMESTAMP),
    KEY(ACT_USER)
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='DOCBASE::CAD OPERADORES';

INSERT INTO DOCSECURITY (OPERADOR, SENHA) VALUES ('admin', DES_ENCRYPT('admin','3vcp69'));

CREATE TABLE DOCDEPARTAMENTOS (
    DP_IDENT    INTEGER NOT NULL AUTO_INCREMENT,
    DP_NOME     VARCHAR(20) DEFAULT NULL,
    PRIMARY KEY(DP_IDENT),
    UNIQUE KEY (DP_NOME)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='DOCBASE::CAD AUXILIAR DE DEPTOS';

INSERT INTO DOCDEPARTAMENTOS (DP_NOME) VALUES ('Adm Geral');
INSERT INTO DOCDEPARTAMENTOS (DP_NOME) VALUES ('Financeiro');
INSERT INTO DOCDEPARTAMENTOS (DP_NOME) VALUES ('Contratos');
INSERT INTO DOCDEPARTAMENTOS (DP_NOME) VALUES ('Contas a Pagar');
INSERT INTO DOCDEPARTAMENTOS (DP_NOME) VALUES ('Contas a Receber');
INSERT INTO DOCDEPARTAMENTOS (DP_NOME) VALUES ('Compras');
INSERT INTO DOCDEPARTAMENTOS (DP_NOME) VALUES ('Faturamento');
INSERT INTO DOCDEPARTAMENTOS (DP_NOME) VALUES ('Vendas');


-- Atualizada em 2013-06-06
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='DOCBASE::ENTIDADES UNIFICADO';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='DOCBASE::DET DOCS DIGITALIZADOS';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='DOCBASE::ARQUIVOS DIGITALIZADOS';
